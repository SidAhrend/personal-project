      ...
      return (
        <div id="edit-dropdown-big-box">
          ...
          <div id="dropdown-edit-button-box">
            <button onClick={() => this.editDog(this.state.id)}>
              Save Dog
            </button>
            <button onClick={this.handleCancel}>Cancel</button>
            <button onClick={() => this.editCat(this.state.id)}>
              Save Cat
            </button>
          </div>
        </div>
                  ...
                  <div id="edit-button-box">
                    ...
                    <div>
                      <button
                        ...
                        className="admin-edit-buttons"
                        onClick={() => this.deleteDog(pet.id)}
                      >
                        delete
                      </button>
                      <button
                        ...
                        className="admin-edit-buttons"
                        onClick={() => this.handleEdit(pet.id)}
                      >
                        edit
                      </button>
                    </div>
